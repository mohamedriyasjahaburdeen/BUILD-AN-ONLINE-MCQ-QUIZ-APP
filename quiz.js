...
function checkAnswer() {
    ...
    if(jsonData.length-1 < i){
        document.write("<body style='background-color:#757575;'>");
        document.write("<div style='color:#ffffff;font-size:24pt;text-align:center;'>*****Your score is : "+correctCount+"/5*****</div>");
        document.write("</body>");
    }
